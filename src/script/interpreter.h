...
/** Signature hash type */
// indicates what parts of transaction the signature signs
// unsigned parts of transaction may be modified
// the default is SIGHASH_ALL
enum
{
...
enum
{
    ...
    // Evaluating a pubkey that is not (0x04 + 64 bytes) nor (0x02 or 0x03 + 32 bytes) by checksig causes script failure
    ...
    // executed, like within an unexecuted IF ENDIF block, are *not* rejected
