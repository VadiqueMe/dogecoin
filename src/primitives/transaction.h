...
public:
    ...
    // Dogecoin: use v1 for compatibility with 1.10
...
public:
    /** Construct a CTransaction that IsNull() */
    CTransaction() ;
    ...
    std::string ToString( bool dumpInsOuts = true ) const ;
...
/** Compute the virtual weight of a transaction, as defined by BIP 141 */
int64_t GetVirtualWeightOfTransaction( const CTransaction & tx ) ;
