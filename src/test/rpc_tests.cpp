...
BOOST_AUTO_TEST_CASE(rpc_ban)
{
    ...
    BOOST_CHECK_THROW(r = CallRPC(std::string("setban 127.0.0.0:12345")), std::runtime_error); // portnumber for setban is an error
    ...
    BOOST_CHECK_NO_THROW(r = CallRPC(std::string("setban 127.0.0.0/24 add 1609632100 true")));
    BOOST_CHECK_NO_THROW(r = CallRPC(std::string("listbanned")));
    ar = r.get_array();
    o1 = ar[0].get_obj();
    ...
    BOOST_CHECK_EQUAL(banned_until.get_int64(), 1609632100); // absolute time check
