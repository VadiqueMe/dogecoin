...
BOOST_AUTO_TEST_CASE( bloom_create_insert_key )
{
    ...
    BOOST_CHECK( vchSecret.SetString( strSecret, Params() ) ) ;
...
BOOST_AUTO_TEST_CASE(bloom_match)
{
    ...
    CDataStream spendStream( vch, SER_DISK, PEER_VERSION ) ;
...
BOOST_AUTO_TEST_CASE(merkle_block_1)
{
    ...
    BOOST_CHECK( merkleBlock.header.GetSha256Hash() == block.GetSha256Hash() ) ;
